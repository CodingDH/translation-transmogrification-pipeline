...
def verify_directionality(console: Console, grouped_terms_df: pd.DataFrame, grouped_terms_output_path: str, directionality_df: pd.DataFrame) -> pd.DataFrame:
	"""
	...
	----------
	console : Console
		Rich console object for output
...
def verify_terms(console: Console, merged_lang_terms_df: pd.DataFrame, processed_translated_terms_output_path: str, use_html_verification: bool = True, defer_verification: bool = False) -> pd.DataFrame:
	"""
...
def run_html_verification(console: Console, initial_translated_terms_df: pd.DataFrame, data_directory_path: str) -> pd.DataFrame:
	"""

...
# We reference them but they're provided by the caller
console = None
translate_client = None

def set_globals(console_obj, translate_client_obj):
    """Set global objects needed by this module."""
    global console, translate_client
    console = console_obj
...
def is_enmt_model_available(target_lang: str) -> bool:
	"""
